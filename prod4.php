            ...
            <div class="container midnav">
                <div class="col-md-3">
                    <div class="text-center">
                        ...
                        <div class="caption text-center">
                            <a href="prod1.php">Interchangeable Lens Camera</a>
                        </div>
                    </div>
                </div>
                <div class="col-md-3">
                ...
                <div class="col-md-3">
                    <div class="text-center">
                        ...
                        <div class="caption text-center">
                            <a href="prod4.php" class="active">Camera Accessories</a>
                        </div>
                    </div>
                </div>
            </div><hr/><br/><br/>
            ...
            <div class="container">
                <div class="col-md-8">
                    <div class="page-header">
                        <h3 class="text-center">Camera Accessories</h3>
                    </div>
                    <div class="col-md-4">
                        <div class="thumbnail">
                            <img src="img/accs1.png" style="width: 100%;"/>
                            <div class="caption prodlink">
                                <h4><a href="product.php">Mount Adapter EF-EOS R</a></h4>
                                <p> 
                                ...
                                <b><p class="text-right">PHP 30,000</p></b>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="thumbnail">
                            <img src="img/accs2.png" style="width: 100%;"/>
                            <div class="caption prodlink">
                                <h4><a href="product.php" >Speedlite Transmitter ST-E10</a></h4>
                                <p> 
                                    Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. 
                                    Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. 
                                    Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur. 
                                    Excepteur sint occaecat. Voluptate velit esse cillum.
                                </p>
                                <b><p class="text-right">PHP 45,000</p></b>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="thumbnail">
                            <img src="img/accs4.png" style="width: 100%;"/>
                            <div class="caption prodlink">
                                <h4><a href="product.php" >Multi-Function Shoe Adapter AD-E1</a></h4>
                                <p> 
                                    Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. 
                                    Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. 
                                    Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur. 
                                ...
                                <b><p class="text-right">PHP 75,000</p></b>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="thumbnail">
                            <img src="img/accs3.png" style="width: 100%;"/>
                            <div class="caption prodlink">
                                <h4><a href="product.php" >Speedlite EL-100</a></h4>
                                <p> 
                                    Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. 
                                    Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. 
                                ...
                                <b><p class="text-right">PHP 25,000</p></b>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-md-4">
                        <div class="thumbnail">
                            <img src="img/accs5.png" style="width: 100%;"/>
                            <div class="caption prodlink">
                                <h4><a href="product.php" >Multi-Function Shoe Directional Stereo Microphone DM-E1D</a></h4>
                                <p> 
                                    Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. 
                                    Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. 
                                    Duis aute irure.
                    ...
                    <div class="col-md-4">
                        <div class="thumbnail">
                            <img src="img/accs6.png" style="width: 100%;"/>
                            <div class="caption prodlink">
                                <h4><a href="product.php" >Battery Grip BG-R10</a></h4>
                                <p> 
                                    Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. 
                                    Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. 
                                    Duis aute irure dolor in reprehenderit in voluptate velit esse cillum.
                                ...
                                <b><p class="text-right">PHP 23,000</p></b>
                            </div>
                        </div>
                    </div>
