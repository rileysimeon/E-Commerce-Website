            ...
            <div class="container midnav">
                ...
                <div class="col-md-3">
                    <div class="text-center">
                        ...
                        <div class="caption text-center">
                            <a href="prod2.php" class="active">Digital Cameras</a>
                        </div>
                    </div>
                </div>
                <div class="col-md-3">
            ...
            <div class="container">
                <div class="col-md-8">
                    <div class="page-header">
                        <h3 class="text-center">Digital Cameras</h3>
                    </div>
                    <div class="col-md-4">
                        <div class="thumbnail">
                            <img src="img/digicam1.png" style="width: 100%;"/>
                            <div class="caption prodlink">
                                <h4><a href="product.php">PowerShot G7 X Mark III</a></h4>
                                <p> 
                    ...
                    <div class="col-md-4">
                        <div class="thumbnail">
                            <img src="img/digicam2.png" style="width: 100%;"/>
                            <div class="caption prodlink">
                                <h4><a href="product.php" >PowerShot G7 X Mark II</a></h4>
                                <p> 
                                    Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. 
                                    Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. 
                                    Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur. 
                                ...
                                <b><p class="text-right">PHP 35,000</p></b>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="thumbnail">
                            <img src="img/digicam3.png" style="width: 100%;"/>
                            <div class="caption prodlink">
                                <h4><a href="product.php" >PowerShot PICK</a></h4>
                                <p> 
                                    Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. 
                                    Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. 
                                    Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur. 
                    ...
                    <div class="col-md-4">
                        <div class="thumbnail">
                            <img src="img/digicam4.png" style="width: 100%;"/>
                            <div class="caption prodlink">
                                <h4><a href="product.php" >PowerShot ZOOM (White)</a></h4>
                                <p> 
                                    Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. 
                                    Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. 
                                    Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur. 
                                ...
                                <b><p class="text-right">PHP 20,000</p></b>
                            </div>
                        </div>
                    </div>                  
                </div>
