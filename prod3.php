            ...
            <div class="container midnav">
                ...
                <div class="col-md-3">
                    <div class="text-center">
                        ...
                        <div class="caption text-center">
                            <a href="prod3.php" class="active">Lenses</a>
                        </div>
                    </div>
                </div>
                <div class="col-md-3">
            ...
            <div class="container">
                <div class="col-md-8">
                    <div class="page-header">
                        <h3 class="text-center">Camera Lenses</h3>
                    </div>
                    <div class="col-md-4">
                        <div class="thumbnail">
                            <img src="img/lens2.png" style="width: 100%;"/>
                            <div class="caption prodlink">
                                <h4><a href="product.php">RF70-200mm f/4L IS USM</a></h4>
                                <p> 
                                ...
                                <b><p class="text-right">PHP 165,000</p></b>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="thumbnail">
                            <img src="img/lens2.png" style="width: 100%;"/>
                            <div class="caption prodlink">
                                <h4><a href="product.php" >TS-E50mm f/2.8L Macro</a></h4>
                                <p> 
                                    Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. 
                                    Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. 
                                    Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur. 
                                ...
                                <b><p class="text-right">PHP 155,000</p></b>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="thumbnail">
                            <img src="img/lens3.png" style="width: 100%;"/>
                            <div class="caption prodlink">
                                ...
                                <b><p class="text-right">PHP 145,000</p></b>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="thumbnail">
                            <img src="img/lens4.png" style="width: 100%;"/>
                            <div class="caption prodlink">
                                <h4><a href="product.php" >TS-E135mm f/4L Macro</a></h4>
                                <p> 
                                    Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. 
                                    Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. 
                                    Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur. 
                                ...
                                <b><p class="text-right">PHP 157,000</p></b>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="thumbnail">
                            <img src="img/lens5.png" style="width: 100%;"/>
                            <div class="caption prodlink">
