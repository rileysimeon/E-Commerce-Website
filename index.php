        ...
        <nav class="navbar navbar-doublerow navbar-trans navbar-fixed-top">
				...
				<div class="container">
					<div class="collapse navbar-collapse" id="myNavbar2">
						<ul class="nav navbar-nav navbar-nav-right">
							<li class="item active"><a href="index.php">Products</a></li>
            ...
            <div class="container">
                <div class="col-md-8">
                    ...
                    <div class="col-md-4">
                        <div class="thumbnail">
                            <img src="img/cam2.png" style="width: 100%;"/>
                            <div class="caption prodlink">
                    ...
                    <div class="col-md-4">
                        <div class="thumbnail">
                            <img src="img/cam3.png" style="width: 100%;"/>
                            <div class="caption prodlink">
                    ...
                    <div class="col-md-4">
                        <div class="thumbnail">
                            <img src="img/cam7.png" style="width: 100%;"/>
                            <div class="caption prodlink">
                                <h4 class="text-muted"><a href="product.php">EOS R6 Mark II (Body)</a></h4>
                                <p> 
                                    Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. 
                                    Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. 
                                    Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur. 
                                ...
                                <b><p class="text-right">PHP 180,000</p></b>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="thumbnail">
                            <img src="img/cam8.png" style="width: 100%;"/>
                            <div class="caption prodlink">
                                <h4 class="text-muted"><a href="product.php">EOS R3 (Body)</a></h4>
                                <p> 
                                    Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. 
                                    Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. 
                                    Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur. 
                                ...
                                <b><p class="text-right">PHP 390,000</p></b>
                            </div>
                        </div>
                    </div>
                </div>
